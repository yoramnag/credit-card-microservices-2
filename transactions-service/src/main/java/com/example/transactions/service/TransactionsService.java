...
import com.example.transactions.exception.TransactionsNotFoundException;
import com.example.transactions.dao.TransactionsRepository;
...
public class TransactionsService {
	...
	@Autowired
	private BlackListProxy blackListProxy;
	...
	private void addCardToBlalList(Transactions transactions) {
		...
		blackListProxy.createBlackListCard(blackList);
//		BlackList blackList = new BlackList();
//		blackList.setCreditCard(transactions.getCreditCard());
//		blackListService.saveBlackListRepository(blackList);
	...
	private void checkBlackList(Transactions transactions) {
		if(blackListProxy.findCreditCard(transactions.getCreditCard())) {
